...
const Showcase: FC = () => (
  <section className="relative my-24">
    ...
    <div className="container relative grid grid-cols-1 grid-rows-4 gap-7 sm:grid-cols-2 sm:grid-rows-2 md:grid-cols-3">
      <a className="relative row-span-2 after:absolute after:inset-0 after:h-full after:w-full after:rounded-lg after:bg-darken-image after:shadow-border after:content-[''] sm:col-span-1 md:col-span-2" href="/apply">
      ...
      <a className="relative after:absolute after:inset-0 after:h-full after:w-full after:rounded-lg after:bg-darken-image after:shadow-border after:content-['']" href="/team">
        <figure className="relative flex h-full overflow-hidden rounded-xl">
          <Image
